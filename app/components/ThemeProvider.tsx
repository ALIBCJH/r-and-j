...
export function useThemeColors() {
  ...
  return {
    ...
    // ── Studio shell ────────────────────────────────────────────────────────
    studioBg:       isDark ? '#0D1B2E' : '#F3F0EB',
    studioNav:      isDark ? '#091220' : '#FFFFFF',
    studioNavBorder:isDark ? 'rgba(201,168,76,0.12)' : 'rgba(27,58,107,0.1)',
    studioText:     isDark ? '#E8E0D0' : '#1B3A6B',
    studioMuted:    isDark ? '#5A7088' : '#6A6258',
    studioDivider:  isDark ? 'rgba(201,168,76,0.1)' : 'rgba(27,58,107,0.12)',
    // ── Studio panel (ConfigPanel) ───────────────────────────────────────────
    panelBg:        isDark ? '#0A1525' : '#FFFFFF',
    panelBorder:    isDark ? 'rgba(201,168,76,0.1)' : 'rgba(27,58,107,0.1)',
    panelText:      isDark ? '#E8E0D0' : '#1B3A6B',
    panelMuted:     isDark ? '#6A8098' : '#7A7268',
    panelSubtle:    isDark ? '#3A5068' : '#9A9088',
    panelDivider:   isDark ? 'rgba(201,168,76,0.08)' : 'rgba(27,58,107,0.08)',
    panelItemBg:    isDark ? 'rgba(255,255,255,0.03)' : 'rgba(27,58,107,0.04)',
    panelItemHover: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(27,58,107,0.08)',
    panelIconBg:    isDark ? 'rgba(201,168,76,0.08)' : 'rgba(27,58,107,0.08)',
    panelItemText:  isDark ? '#E8E0D0' : '#1B3A6B',
    panelItemSub:   isDark ? '#4A6278' : '#9A9088',
  }
}
